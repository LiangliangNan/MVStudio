...
double align_horn(int n, easy3d::dvec3 *right_pts, easy3d::dvec3 *left_pts,
		  double *R, double *T, double *Tout, 
		  double *scale, double *weight);

/* Align two sets of points with a 3D rotation */
double align_3D_rotation(int n, easy3d::dvec3 *r_pts, easy3d::dvec3 *l_pts, double *R);
...
double align_horn_3D(int n, easy3d::dvec3 *right_pts, easy3d::dvec3 *left_pts, int scale_xform,
		     double *Tout);    

double align_horn_3D_2(int n, easy3d::dvec3 *right_pts, easy3d::dvec3 *left_pts, int scale_xform,
                       double *Tout);

int align_2D_ransac(int n, easy3d::dvec3 *r_pts, easy3d::dvec3 *l_pts,
                    int num_ransac_rounds, double ransac_thresh,
                    double *Tret);

/* Align two sets of points with a 2D similarity transform */
int align_horn_ransac(int n, easy3d::dvec3 *r_pts, easy3d::dvec3 *l_pts,
                      int num_ransac_rounds, double ransac_thresh,
                      double *Tret);

/* Align two sets of points with a 3D similarity transform */
int align_horn_3D_ransac(int n, easy3d::dvec3 *r_pts, easy3d::dvec3 *l_pts,
                         int num_ransac_rounds, double ransac_thresh,
                         double *Tret);
    
/* Align two sets of points with a 3D rotation */
int align_3D_rotation_ransac(int n, easy3d::dvec3 *r_pts, easy3d::dvec3 *l_pts,
			     int num_ransac_rounds, double ransac_thresh,
			     double *R);
