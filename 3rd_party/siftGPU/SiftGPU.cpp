...
int SiftGPU::RunSIFT() {
    ...
    if (_image_loaded == 0) {
        ...
        if (!_texImage->LoadImageFile(_imgpath, width, height)) {
            ...
            default:
                ...
                switch (opti) {
                    ...
                    case MAKEINT3(t, c, 1):  //
                    {
                        switch (opti) {
                            case MAKEINT3(t, c, 2):
                                GlobalUtil::_TruncateMethod = 1;
                                break;
                            case MAKEINT3(t, c, 3):
                                GlobalUtil::_TruncateMethod = 2;
                                break;
                            default:
                                GlobalUtil::_TruncateMethod = 0;
                                break;
                        }
                        int num = -1;
